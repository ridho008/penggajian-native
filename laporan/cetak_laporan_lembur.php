...
<hr width="200">
<p align="center">LAPORAN DATA LEMBUR PEGAWAI</p>
...
<table border="1" cellpadding="10" cellspacing="0" align="center" width="100%">
	<tr>
		...
		<th>Jabatan</th>
		<th>Golongan</th>
		<th>Jml Lembur (Jam)</th>
		<th>Uang Lembur</th>
		<th>Total</th>
	</tr>
	<?php 
	$sql = mysqli_query($konek, "SELECT pegawai.nip, pegawai.nama_pegawai, jabatan.nama_jabatan, 
		golongan.nama_golongan, master_gaji.lembur, golongan.uang_lembur, uang_lembur * lembur AS total 
		FROM pegawai 
