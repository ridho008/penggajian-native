...
<hr width="200">
<p align="center">LAPORAN DATA KEHADIRAN PEGAWAI</p>
...
<table border="1" cellpadding="10" cellspacing="0" align="center" width="100%">
	...
	<?php 
	$sql = mysqli_query($konek, "SELECT pegawai.nip, pegawai.nama_pegawai, jabatan.nama_jabatan, golongan.nama_golongan, master_gaji.masuk, uang_makan, uang_makan * masuk AS total 
		FROM pegawai 
