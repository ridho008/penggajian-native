			...
			<div class="row">
				<div class="col-md">
					...
					<!-- <center> -->
						...
						<a href="laporan/excel_daftar_gaji_pegawai.php?bulan=<?= $bulan; ?>&tahun=<?= $tahun; ?>" class="btn btn-warning"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-file-earmark-spreadsheet" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
